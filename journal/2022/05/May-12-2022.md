...
A regenerative system then employs a series of interchanges where a human provides input and the system rebuilds itself to be consistent with those changes.